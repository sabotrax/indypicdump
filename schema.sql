...
CREATE TABLE picture(id integer primary key autoincrement, filename text, time_taken int, time_send int, id_user int, original_hash text, id_pool int);
CREATE TABLE pool(id integer primary key autoincrement, alias text, time_created int);
